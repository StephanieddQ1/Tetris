/*
This is the display class for the tetris game project
Alfred Okonkwo
Chiamaka Onwude
...
public class TetrisDisplay extends JPanel {
    ...
    public void paintComponent(Graphics g){
        ...
        int fontNum2=20;
        int cellInc=15;
        Font myFont = new Font ("Arial", 1, fontNum1);
        drawWell(g);
        drawBrick(g);
        drawBackground(g);
        g.setFont(myFont);
        ...
        myFont = new Font ("Arial", 1, fontNum2);
        g.setFont(myFont);
        g.setColor(Color.red);
        if(game.getState() == 0){
            g.drawString("Game Over", cell_size*5, cell_size *cellInc);
        }
    }
